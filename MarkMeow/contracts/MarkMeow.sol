...
contract MarkMeow {
    ...
    mapping(address => bool) public isRegistered;  // 记录捐赠的用户是否已注册（注册用户可以领取奖励）
    ...
    modifier onlyRegistered() {
        require(isRegistered[msg.sender], "You are not a registered donor.");
        _;
    }
    ...
    function donate() public payable {
        ...
        isRegistered[msg.sender] = true; // 捐赠后自动成为注册用户
